<?php /*a:1:{s:42:"../html_template/admin/verify/kladmin.html";i:1531730860;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    layui.use(['element','layer','form'], function(){
        ...
        var table = $('#dateTable').DataTable({
            ...
            "columns": [                            // 自定义数据列
                ...
                {data: function(obj){
                        ...
                        return  '<a class="layui-btn layui-btn-small layui-btn-normal btn-set" data-id='+obj.sid+'>编辑</a>'+'<a class="layui-btn layui-btn-small layui-btn-normal btn-edit" data-id="'+obj.sid+'">二维码</a>';
                    },width:'130'}
            ],
        ...
        $(document).on('click','#btn-delete-all', function(){
            ...
            if(ids == null || ids == ''){
                ...
                deleteAll(ids,"<?php echo url('kldelete'); ?>","<?php echo url('kladmin'); ?>","<?php echo url('kladmin'); ?>");
            }
        });
        $(document).on('click','#btn-delete-flush', function(){
            ...
            layer.msg('刷新成功',{time:500},function(){
                ...
                // 跳转
                window.location.href = "<?php echo url('admin/Verify/kladmin'); ?>";
            })
        });
        // 监听搜索按钮
        ...
        $(document).on('click','.btn-set', function(){
            ...
            layer.open({
                ...
                shade: 0.8,
                area: ['400px', '500px'],
                content: "<?php echo url('set'); ?>?sid="+$(this).attr('data-id')
            });
            // 更新渲染
            form.render();
        });
