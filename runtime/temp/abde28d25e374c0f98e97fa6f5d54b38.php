<?php /*a:1:{s:37:"../html_template/admin/log/index.html";i:1490064818;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="my-btn-box">
    ...
    <form class="fr layui-form">
        ...
        <div class="layui-input-inline">
            <input name="search" type="text" autocomplete="off" placeholder="查询用户名称" class="layui-input" value="<?php echo !empty($search) ? htmlentities($search) : ''; ?>">
        </div>
...
<script type="text/javascript">
    layui.use(['element','form','layer'], function(){
        ...
        $(document).on('click','.btn-delete', function(){
            deleteAll($(this).attr('data-id'),'<?php echo url("delete"); ?>','<?php echo url("index"); ?>','<?php echo url("index"); ?>');
        });
