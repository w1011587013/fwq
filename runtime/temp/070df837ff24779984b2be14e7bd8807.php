<?php /*a:1:{s:37:"../html_template/admin/bak/index.html";i:1490064796;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="my-btn-box">
    ...
    <form class="fr layui-form">
        ...
        <div class="layui-input-inline">
            <input name="search" type="text" autocomplete="off" placeholder="请输入" class="layui-input" value="<?php echo !empty($search) ? htmlentities($search) : ''; ?>">
        </div>
    ...
    layui.use(['element','form','layer'], function(){
        ...
        $(document).on('click','#btn-delete-all', function(){
            ...
            if(ids == null || ids == ''){
                ...
                //layer.msg(list);
                // 删除请求
                deleteAll(ids,"<?php echo url('delete'); ?>","<?php echo url('index'); ?>");
            }
        });
        ...
        $('#btn-bak').on('click',function(){
            ...
            layer.confirm('确认备份数据库?', {
                ...
                // 确认并请求备份接口
                $.post("<?php echo url('back'); ?>",function(res){
                    if(res.status > 0){
                        // 提示并跳转
